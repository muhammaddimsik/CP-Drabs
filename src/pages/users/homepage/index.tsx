            ...
            <section className="pt-10 pb-20">
              <div className="flex flex-col items-center">
                ...
                <div className="w-1/2 mx-auto py-4">
                  <h1 className="text-white text-5xl text-center anton">
        ...
        <section className="container mx-auto mt-20">
          <div className="flex-col items-center">
            <div className="w-full flex justify-center">
              <img src="/analytics.png" alt="analytics" className="w-1/3" />
            </div>
          ...
          <div className="container mx-auto">
            <div className="flex flex-col items-center">
              ...
              <div className="anton text-center text-white text-5xl my-4 space-y-1">
                <h2>Transformasi Bisnis Anda</h2>
                <h2>
                  Dengan <span className="text-[#EDFF71]">Expertise &</span>
                </h2>
                <h2 className="text-[#EDFF71]">Creativity</h2>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center mt-6">
              {dataServices?.map((item) => (
                <div key={item.id_service} className="p-2 w-4/12">
